...
export default function AdminPage() {
  ...
  const load = useCallback(async () => {
    ...
    if (!response.ok) { setError(result.error || "데이터를 읽지 못했습니다."); return; }
    setAuthenticated(true); setLeads(result.leads); setCounts(result); setError("");
  }, []);
